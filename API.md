...
| <code><a href="#cdk-twingate.TwingateConnector.with">with</a></code> | Applies one or more mixins to this construct. |
...
##### `with` <a name="with" id="cdk-twingate.TwingateConnector.with"></a>
...
###### `mixins`<sup>Required</sup> <a name="mixins" id="cdk-twingate.TwingateConnector.with.parameter.mixins"></a>
